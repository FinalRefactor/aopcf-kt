...
class ComponentBinder(private val injector: Injector,
    ...
    interface TransformBinder<T1> {
        ...
        fun <A: Annotation, T: Any> transform(annotation: Class<A>,
                                              to: Class<T>,
                                              map: (T1, A) -> Module): InternalBinder<T>

        fun <A: Annotation, T: Any, S: AnnotatedElement> reform(injector: Injector, stream: Stream<S>, annotation: Class<A>, to: Class<T>, map: (T1, A) -> Module): List<T> {
    ...
    abstract class OptionalTransformBinder<T1>(protected val injector: Injector, protected val binder: Binder) : TransformBinder<T1> {
        ...
        fun <A: Annotation, T: Any, S: AnnotatedElement> optionalReform(injector: Injector, stream: Stream<S>, annotation: Class<A>, to: Class<T>, map: (T1, A) -> Module): List<T> {
    ...
    class InternalBinder<T> internal constructor(private val list: List<T>,
